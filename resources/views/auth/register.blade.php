...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>Register - Eastern Investment FX Trading</title>
				...
				<ul>
					<li>
						<a id="orange-css" href="#" title="orange" class="color"><img
								src="assets/images/styleswitcher/colors/orange.png" alt="" width="30" height="30" /></a>
					</li>
					<li>
						<a id="green-css" href="#" title="green" class="color"><img
								src="assets/images/styleswitcher/colors/green.png" alt="" width="30" height="30" /></a>
					</li>
					<li>
						<a id="blue-css" href="#" title="blue" class="color"><img src="assets/images/styleswitcher/colors/blue.png"
			...
			<div class="container-fluid user-auth">
					...
					<div id="carousel-testimonials" class="carousel slide carousel-fade" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item active item-1">
								<div>
									<blockquote>
										<p>This is a very realistic project, anyone can find a website to invest. Pay me regularly
											and keep up the good work!</p>
										<footer><span>Gold Miner</span>, Germany</footer>
									</blockquote>
								</div>
							</div>
							<!-- Carousel Item Ends -->
							...
							<div class="item item-2">
								<div>
									<blockquote>
										<p>Bitcoin doubled in 30 days. You should have no more expectations. Excellent customer
											service!</p>
										<footer><span>Bitcoin Miner</span>, USA</footer>
									</blockquote>
								</div>
							</div>
							<!-- Carousel Item Ends -->
							...
							<div class="item item-3">
								<div>
									<blockquote>
										<p>My family and I want to thank you for helping us find a great opportunity to make money
											online. How satisfied things are done!</p>
										<footer><span>Crude oil miner</span>, Swiss</footer>
									</blockquote>
								</div>
							</div>
							<!-- Carousel Item Ends -->
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					...
					<a class="visible-xs" href="home.html">
						<img id="logo" class="img-responsive mobile-logo" src="assets/images/logo.png" alt="logo">
					</a>
					<!-- Logo Ends -->
					<div class="">
						<div>
							...
							<div style="text-align: center; display : none;"
								class="col-md-8 col-md-offset-2 alert alert-danger">
								<i class="fa fa-times-circle"></i> Noted Errors: <br />
							</div>
							<!-- Form Starts -->
							<form method="POST" action="{{ route('register') }}" class="">
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<label>City:</label>
									<input id="city" type="city" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" placeholder="Enter City" required autocomplete="city" autofocus>
									@error('city')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<label>Country:</label>
									<select name="country" class="form-control @error('country') is-invalid @enderror" value="{{ old('country') }}" required autofocus>
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
									...
									<input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Enter Password" required autocomplete="password">
									@error('password')
										<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
										</span>
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
									...
									<input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Confirm Password" required autocomplete="password-confirm">
								</div>
								<div class="clearfix"></div>
								<div class="form-group">
									<div class="col-xs-12 col-sm-12 col-md-112 col-lg-offset-3 col-lg-6">
										<button class="btn btn-primary btn-block" name="register" value="Submit"
	...
	<!-- Mirrored from slimhamdi.net:443/bayya/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2019 13:07:05 GMT -->
