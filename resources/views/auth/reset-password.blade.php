...
<html lang="en">
	...
	<!-- Mirrored from us.realstockfx.com/reset/password by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 May 2021 00:30:11 GMT -->
	<!-- Added by HTTrack -->
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>Login - Real Stock FX</title>
				...
				<ul>
					<li>
						<a id="orange-css" href="#" title="orange" class="color"><img
								src="{{ asset('site/images/styleswitcher/colors/orange.html') }}" alt="" width="30" height="30" /></a>
					</li>
					<li>
						<a id="green-css" href="#" title="green" class="color"><img
								src="{{ asset('site/images/styleswitcher/colors/green.html') }}" alt="" width="30" height="30" /></a>
					</li>
					<li>
						<a id="blue-css" href="#" title="blue" class="color"><img src="{{ asset('site/images/styleswitcher/colors/blue.html') }}"
		...
		<div class="wrapper">
			<div class="container-fluid user-auth">
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					...
					<div class="form-container">
						<div>
							...
							<div class="row text-center">
								...
								<p class="info-form">Enter your email to reset your password.</p>
							</div>
							<!-- Section Title Ends -->
							<!-- Form Starts -->
							<form action="{{ route('password.update') }}" method="POST">
								...
								<div class="form-group">
									<input class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" placeholder="ENTER EMAIL" type="text" required autocomplete="email" autofocus>
									@error('email')
								...
								<div class="form-group">
									<input type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" id="password" placeholder="ENTER PASSWORD" type="text" required autocomplete="password" autofocus>
									@error('password')
										<span class="invalid-feedback" role="alert">
											<strong>{{ $message }}</strong>
										</span>
								...
								<div class="form-group">
									<input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" value="{{ old('password_confirmation') }}" id="password_confirmation" placeholder="CONFIRM PASSWORD" type="text" required autocomplete="password_confirmation" autofocus>
								...
								<div class="form-group">
									...
									<p class="text-center"><a href="{{ route('login') }}">login now!</a>
								</div>
					...
					<p class="text-center copyright-text">Copyright © 2021 Real Stock FX All Rights Reserved</p>
					<!-- Copyright Text Ends -->
				</div>
			</div>
			<!-- Template JS Files -->
	...
	<!-- Mirrored from us.realstockfx.com/reset/password by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 May 2021 00:30:20 GMT -->
