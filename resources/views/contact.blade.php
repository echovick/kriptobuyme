            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-8 contact-form">
                        <h3 class="col-xs-12">Drop a message with us</h3>
                            ...
                            <div class="contact-page-info">
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        <h4>Address</h4>
                                        <p>21 Halloway Texas, TX 40055, United States.</p>
                                    </div>
                                </div>
                                ...
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <p>support@easternlinvestmentfx.com</p>
                                    </div>
                                </div>
                                <!-- Contact Info Box Ends -->
