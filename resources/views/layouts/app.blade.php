...
<!-- Mirrored from us.realstockfx.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 May 2021 00:28:02 GMT -->
<!-- Added by HTTrack -->
...
<head>
	<meta charset="utf-8" />
	<title>kripto Büyüme - Center for Bitcoin Trading </title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="main-logo col-xs-12 col-md-3 col-md-2 col-lg-2 hidden-xs">
                        <a href="{{ route('home') }}">
                            <img id="logo" class="img-responsive" src="{{ asset('site/images/logo.png') }}" style="max-height: 100px;" alt="logo">
                        </a>
                    </div>
                    <!-- Logo Ends -->
                    <!-- Statistics Starts -->
                    <div class="col-md-7 col-lg-7">
                        <ul class="unstyled bitcoin-stats text-center">
                            <li>
                                <h6>6,450 USD</h6><span>Last trade price</span></li>
                            <li>
                                <h6>+2.26%</h6><span>24 hour price</span></li>
                            <li>
                                <h6>2.820 BTC</h6><span>24 hour volume</span></li>
                            <li>
                                <h6>231,775</h6><span>active traders</span></li>
                            <li>
                ...
                <div class="container">
                    <div class="site-nav-inner">
                        ...
                        <a class="logo-mobile" href="home.html">
                            <img id="logo-mobile" class="img-responsive" src="{{ asset('site/images/logo.png') }}" alt="">
                        </a>
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                <li class="rxx rx-home {{ request()->is('') ? 'active' : '' }}"><a href="{{ route('home') }}">Home</a></li>
                                <li class="rxx rx-about {{ request()->is('about') ? 'active' : '' }}"><a href="{{ route('about') }}">About Us</a></li>
                                <li class="rxx rx-contact {{ request()->is('contact') ? 'active' : '' }}"><a href="{{ route('contact') }}">Contact Us</a></li>
                                <li class="rxx rx-faqs {{ request()->is('faq') ? 'active' : '' }}"><a href="{{ route('faq') }}">FAQs</a></li>
                                <li class="rxx rx-services {{ request()->is('services') ? 'active' : '' }}"><a href="{{ route('services') }}">Services</a></li>
                                <!-- <li class="dropdown">
...
<!-- Mirrored from slimhamdi.net:443/bayya/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jul 2019 13:05:52 GMT -->

<!-- Mirrored from us.realstockfx.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 May 2021 00:29:14 GMT -->
