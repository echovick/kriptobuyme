			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-12 col-md-5">
							<h4><img src="{{ asset('site/images/logo.png') }}" height="20px;" alt="Bitcoin logo"> kripto Büyüme</h4>
							<!-- Facts Starts -->
							<div class="facts-footer">
								kripto Büyüme holds a Financial Services Licence which authorizes us to issue and act as a responsible entity to registered managed investment schemes and to act as trustee to wholesale unregistered investment schemes worldwide. kripto Büyüme is a member
